...
export const ContractWhitelistedGetLogs: { [key: string]: Array<string> } = {
  ethereum: [
    ...
    ...YearnVaults.filter((item) => item.chain === 'ethereum').map((item) => item.address),
    ...
    '0xec0820efafc41d8943ee8de495fc9ba8495b15cf', // Crvusd controller sfrxETH v2
    '0x1c91da0223c763d2e0173243eadaa0a2ea47e704', // Crvusd controller tBTC
  ...
  arbitrum: [
    ...
    '0xa669e7a0d4b3e4fa48af2de86bd4cd7126be4e13', // Odos router v2
  ],
